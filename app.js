...
db.run("CREATE TABLE projects (pid INTEGER PRIMARY KEY, pname TEXT NOT NULL, pyear INTEGER NOT NULL, pdesc TEXT NOT NULL, ptechdesc TEXT NOT NULL, ptype TEXT NOT NULL, pimgURL TEXT NOT NULL, github TEXT NOT NULL)", (error) => {
  ...
  console.log("ERROR: ", error)
    ...
    const projects=[
      ...
      { "id":"2", "name":"Paint App", "type":"Research", "desc": "Dive into a world of creativity with this simple painting application. Harnessing intricate algorithms, this app offers boundary-fill, flood-fill, and scan-line fill techniques to bring your artistic visions to life.", "year": 2022, 
      ...
      { "id":"3", "name":"Notes Android App", "desc": "Organize your thoughts and tasks with the Notes Android App – a sleek, user-friendly mobile application for note-taking on the go.", "year": 2023, "type":"Education", 
      ...
      "url":"/img/NoteApp.jpg" , "github":"https://github.com/Sam-Code97/Notes-Android-App"},
      ...
      { "id":"6", "name":"Simple Notepad", "desc": "A lightweight notepad application developed in C++ using the Qt framework. It offers essential features like opening, saving, and clearing text files, all wrapped in a user-friendly graphical interface.", "year": 2022, "type":"Other", 
      ...
      { "id":"7", "name":"Encryption Tool", "desc": "A robust encryption tool built in Java that offers both encryption and decryption functionalities. With a user-friendly GUI, users can easily input text and an encryption key to get the desired encrypted or decrypted output.", "year": 2023, "type":"Education", 
